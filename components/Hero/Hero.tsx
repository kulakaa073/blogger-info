        ...
        <div className="ds:grid-area-bottom flex flex-col items-center w-full ds:w-133.5">
          <ScrollWrap targetSection="plans">
            ...
            >
              ...
              <span
                aria-hidden="true"
                className="bg-red-2 h-15 ds:h-18.5 w-14.75 ds:w-18.5 flex items-center ds:justify-center absolute right-0 top-0 rounded-full text-white text-xl ds:text-2xl leading-6.5 ds:leading-[36.8px]"
              >
                -50%
              </span>
            </button>
          ...
          <p className="font-raleway font-semibold text-xl/5.5 ds:text-2xl ds:leading-[36.8px] text-red-2 flex items-center gap-[9.38px]">
            <ins className="no-underline">1000 грн</ins>
            <del className="no-underline relative text-sm text-gray inline-block px-[1.4px] ds:px-1">
              2000грн
