...
const PromoBlock = ({ language }: PromoBlockProps) => {
  return (
    <section
      id="cta"
      className="w-full py-[1px] [background:var(--gradient-main)] mb-12 ds:mb-14.75"
    >
